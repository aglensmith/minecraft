...
screenName = "paper" # Name of opened screen where the Minecraft server is online.
...
serverPath = "/home/mcadmin/paper/" # Path to folder of server to be backed up.
savePath = "/home/mcadmin/backups/" # To keep backup archives

# Archive Naming
datetime = time.strftime("%m-%d-%Y--%I:%M%p") # Time format
archiveName = "World_Backup_" + datetime  # Name of backup archive
...
keepFileTime = 3 # Time in days to wait before deleting an old backup.
